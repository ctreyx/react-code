(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.ReactDom = global.ReactDom || {}, global.ReactDom.js = factory(global.React)));
	...
	/*
	 * @Author: fumi 330696896@qq.com
	 * @Date: 2024-08-16 17:32:18
	 * @LastEditors: fumi 330696896@qq.com
	 * @LastEditTime: 2024-08-16 17:33:31
	 * @FilePath: \react\packages\shared\internals.ts
	 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
	 */
	...
	function mountWorkInProgressHook() {
	    ...
	    if (workInProgressHook === null) {
	        ...
	        if (currentlyRenderingFiber === null) {
	            ...
	            throw new Error('Cannot render hooks outside of a function component,请在函数组件调用');
	        }
	        else {
